...
const CATEGORIES = {
  ...
  "ferramentas": [
    ...
    { "code": "FR044", "label": "BITS ALLEN 2.5 X 25" },
    { "code": "FR045", "label": "BITS ALLEN 3 X 25" },
    { "code": "FR046", "label": "BITS ALLEN 4 X 25" },
    { "code": "FR047", "label": "BITS ALLEN 4 X 50" },
    { "code": "FR048", "label": "BITS ALLEN 5 X 25" },
    { "code": "FR049", "label": "BITS ALLEN 5 X 50" },
    { "code": "FR050", "label": "BITS ALLEN 5 X 75" },
    { "code": "FR051", "label": "BITS PHILLIPS 3/16 X 25 PH1" },
    { "code": "FR052", "label": "BITS PHILLIPS 3/16 X 50 PH1" },
    { "code": "FR053", "label": "BITS PHILLIPS 1/4 X 25 PH2" },
    { "code": "FR054", "label": "BITS PHILIPS 1/4 X 50PH2" },
    { "code": "FR055", "label": "BITS T T15 X 50" },
    { "code": "FR056", "label": "BITS T20 X 50" },
    { "code": "FR057", "label": "BITS T25 X 25" },
    { "code": "FR058", "label": "BITS T25 X 50" },
    { "code": "FR059", "label": "BITS T30 X 25" },
    { "code": "FR060", "label": "BITS T30 X 50" },
    { "code": "FR061", "label": "BITS T30 1/4 X 75" },
    { "code": "FR062", "label": "BITS T30 1/4 X 100" },
    ...
    { "code": "FR023", "label": "CHAVE DE FENDA 1/4 X 6" },
    { "code": "FR062", "label": "CHAVE DE FENDA 1/8 X 6" },
    { "code": "FR024", "label": "CHAVE PHILIPS 1/4 X 6" },
    { "code": "FR063", "label": "CHAVE PHILIPS 1/8 X 6" },
